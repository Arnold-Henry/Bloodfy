...
import '../Centers/center_dashboard.dart';
          ...
          child: SafeArea(
            ...
            child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    const Text(
                      'Please Enter Donation Drive Details',
                      style: TextStyle(
                        fontSize: 20,
                          ...
                          if (locationResult == null) {
                            ...
                            Provider.of<DataManagerProvider>(context,
                                ...
                                .setDonationDriveInfo(
                                    ...
                                    startingTime.format(context),
                                    endingTime.format(context));
                            addDonationDriveInfo(context).whenComplete(() {
                             // Navigator.pushReplacement(
                                 // context,
                                 // CupertinoPageRoute(
                                    //  builder: (context) => const DriveCard()));
                            });
                          }
                        }
